...
class CurriculumJSONTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.file_path =  current_directory.parent/"src"/"data"/"curriculum.json"
    ...
    def test_file_contains_json(self):
        try:
            ...
            self.fail(f"Error reading JSON data from {self.file_path}: {str(e)}")
...
if __name__ == '__main__':
    unittest.main()
python tests/curriculum_test.py